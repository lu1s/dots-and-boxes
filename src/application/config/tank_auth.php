...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Dots and Boxes';
$config['webmaster_email'] = 'hi@dotsandboxes.co.cc';
...
$config['recaptcha_public_key'] = '6LdPKtASAAAAAFXzc8ELUgiONmoY_yd1BsZ39V--';
$config['recaptcha_private_key'] = '6LdPKtASAAAAAECo-PVev0CP7I7xWzQV-BXX551J';
